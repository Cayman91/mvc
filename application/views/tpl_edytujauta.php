...
<br/>
    ...
    <input type="text" name="nazwaAuta" value="<?php echo $auto['samochody_nazwa'] ?>"/>
    <br/>
    <input type="text" name="opis" value="<?php echo $auto['samochody_opis'] ?>"/>
    <br/>
    <input type="hidden" name="id" value="<?php echo $auto['samochody_id'] ?>"/>
    <br/>
